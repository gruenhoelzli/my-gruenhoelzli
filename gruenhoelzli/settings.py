"""
Django settings for gruenhoelzli project.
"""
...
ROOT_URLCONF = 'gruenhoelzli.urls'

DATABASES = {
    'default': {
        'ENGINE': os.environ.get('JUNTAGRICO_DATABASE_ENGINE','django.db.backends.sqlite3'), 
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','gruenhoelzli.db'), 
...
WSGI_APPLICATION = 'gruenhoelzli.wsgi.application'
